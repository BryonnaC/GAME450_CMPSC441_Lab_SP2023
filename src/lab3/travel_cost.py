...
def get_route_cost(route_coordinate, game_map):
    ...
    if(x_diff == 0):
      ...
      if( y_abs < x_abs):
        ...
        diag_moves = y_abs    # this was wrong before - bug fix
      ...
      for i in range(0, diag_moves): # Change*d* this to diag_moves, but does that mess with my neg/pos? probably
    ...
    if(x_abs > y_abs):
      ...
      remain_moves = x_abs - y_abs  # this is correct, the other moves calc should fix bug
    if(y_abs > x_abs):
